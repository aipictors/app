...
const ViewerImageGenerationStatus = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'ViewerImageGenerationStatus'),
  variableDefinitions: [],
  directives: [],
  selectionSet: _i1.SelectionSetNode(selections: [
    ...
    _i1.FieldNode(
      ...
      selectionSet: _i1.SelectionSetNode(selections: [
        ...
        _i1.FieldNode(
          name: _i1.NameNode(
              value: 'inProgressImageGenerationReservedTasksCount'),
          alias: null,
          arguments: [],
          directives: [],
          selectionSet: null,
        ...
        _i1.FieldNode(
          name:
              _i1.NameNode(value: 'availableConsecutiveImageGenerationsCount'),
          alias: null,
          arguments: [],
          directives: [],
          selectionSet: null,
...
const document = _i1.DocumentNode(definitions: [ViewerImageGenerationStatus]);

...
Serializer<GFeedLatestWorksData_works_user_viewer>
    _$gFeedLatestWorksDataWorksUserViewerSerializer =
    new _$GFeedLatestWorksData_works_user_viewerSerializer();
  ...
  Iterable<Object?> serialize(
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType:
                const FullType(GFeedLatestWorksData_works_user_viewer)));
    }
    return result;
  }
      ...
      switch (key) {
        ...
        case 'viewer':
          result.viewer.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(GFeedLatestWorksData_works_user_viewer))!
              as GFeedLatestWorksData_works_user_viewer);
          break;
      }
    }
...
class _$GFeedLatestWorksData_works_user_viewerSerializer
    implements StructuredSerializer<GFeedLatestWorksData_works_user_viewer> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GFeedLatestWorksData_works_user_viewer';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GFeedLatestWorksData_works_user_viewer object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      '__typename',
      serializers.serialize(object.G__typename,
  ...
  @override
  GFeedLatestWorksData_works_user_viewer deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GFeedLatestWorksData_works_user_viewerBuilder();
...
class _$GFeedLatestWorksData_works_user
  ...
  @override
  final GFeedLatestWorksData_works_user_viewer? viewer;
...
class GFeedLatestWorksData_works_userBuilder
  ...
  GFeedLatestWorksData_works_user_viewerBuilder? _viewer;
  GFeedLatestWorksData_works_user_viewerBuilder get viewer =>
      _$this._viewer ??= new GFeedLatestWorksData_works_user_viewerBuilder();
  set viewer(GFeedLatestWorksData_works_user_viewerBuilder? viewer) =>
      _$this._viewer = viewer;
...
class _$GFeedLatestWorksData_works_user_viewer
    extends GFeedLatestWorksData_works_user_viewer {
  @override
  final String G__typename;
  @override
  final String id;
  ...
  factory _$GFeedLatestWorksData_works_user_viewer(
          [void Function(GFeedLatestWorksData_works_user_viewerBuilder)?
              updates]) =>
      (new GFeedLatestWorksData_works_user_viewerBuilder()..update(updates))
          ._build();

  _$GFeedLatestWorksData_works_user_viewer._(
      {required this.G__typename,
      required this.id,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        G__typename, r'GFeedLatestWorksData_works_user_viewer', 'G__typename');
    BuiltValueNullFieldError.checkNotNull(
        id, r'GFeedLatestWorksData_works_user_viewer', 'id');
    BuiltValueNullFieldError.checkNotNull(
        isFollower, r'GFeedLatestWorksData_works_user_viewer', 'isFollower');
    BuiltValueNullFieldError.checkNotNull(
        isFollowee, r'GFeedLatestWorksData_works_user_viewer', 'isFollowee');
    BuiltValueNullFieldError.checkNotNull(
        isMuted, r'GFeedLatestWorksData_works_user_viewer', 'isMuted');
  }

  @override
  GFeedLatestWorksData_works_user_viewer rebuild(
          void Function(GFeedLatestWorksData_works_user_viewerBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GFeedLatestWorksData_works_user_viewerBuilder toBuilder() =>
      new GFeedLatestWorksData_works_user_viewerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GFeedLatestWorksData_works_user_viewer &&
        G__typename == other.G__typename &&
        id == other.id &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'GFeedLatestWorksData_works_user_viewer')
          ..add('G__typename', G__typename)
          ..add('id', id)
...
class GFeedLatestWorksData_works_user_viewerBuilder
    implements
        Builder<GFeedLatestWorksData_works_user_viewer,
            GFeedLatestWorksData_works_user_viewerBuilder> {
  _$GFeedLatestWorksData_works_user_viewer? _$v;
  ...
  GFeedLatestWorksData_works_user_viewerBuilder() {
    GFeedLatestWorksData_works_user_viewer._initializeBuilder(this);
  }

  GFeedLatestWorksData_works_user_viewerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _G__typename = $v.G__typename;
      _id = $v.id;
  ...
  @override
  void replace(GFeedLatestWorksData_works_user_viewer other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GFeedLatestWorksData_works_user_viewer;
  }

  @override
  void update(
      void Function(GFeedLatestWorksData_works_user_viewerBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GFeedLatestWorksData_works_user_viewer build() => _build();

  _$GFeedLatestWorksData_works_user_viewer _build() {
    final _$result = _$v ??
        new _$GFeedLatestWorksData_works_user_viewer._(
            G__typename: BuiltValueNullFieldError.checkNotNull(G__typename,
                r'GFeedLatestWorksData_works_user_viewer', 'G__typename'),
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'GFeedLatestWorksData_works_user_viewer', 'id'),
            isFollower: BuiltValueNullFieldError.checkNotNull(isFollower,
                r'GFeedLatestWorksData_works_user_viewer', 'isFollower'),
            isFollowee: BuiltValueNullFieldError.checkNotNull(isFollowee,
                r'GFeedLatestWorksData_works_user_viewer', 'isFollowee'),

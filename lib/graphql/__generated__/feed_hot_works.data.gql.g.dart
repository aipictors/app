...
Serializer<GFeedHotWorksData_hotWorks_user_viewer>
    _$gFeedHotWorksDataHotWorksUserViewerSerializer =
    new _$GFeedHotWorksData_hotWorks_user_viewerSerializer();
  ...
  Iterable<Object?> serialize(
    ...
    if (value != null) {
      result
        ...
        ..add(serializers.serialize(value,
            specifiedType:
                const FullType(GFeedHotWorksData_hotWorks_user_viewer)));
    }
    return result;
  }
      ...
      switch (key) {
        ...
        case 'viewer':
          result.viewer.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(GFeedHotWorksData_hotWorks_user_viewer))!
              as GFeedHotWorksData_hotWorks_user_viewer);
          break;
      }
    }
...
class _$GFeedHotWorksData_hotWorks_user_viewerSerializer
    implements StructuredSerializer<GFeedHotWorksData_hotWorks_user_viewer> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GFeedHotWorksData_hotWorks_user_viewer';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GFeedHotWorksData_hotWorks_user_viewer object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      '__typename',
      serializers.serialize(object.G__typename,
  ...
  @override
  GFeedHotWorksData_hotWorks_user_viewer deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GFeedHotWorksData_hotWorks_user_viewerBuilder();
...
class _$GFeedHotWorksData_hotWorks_user
  ...
  @override
  final GFeedHotWorksData_hotWorks_user_viewer? viewer;
...
class GFeedHotWorksData_hotWorks_userBuilder
  ...
  GFeedHotWorksData_hotWorks_user_viewerBuilder? _viewer;
  GFeedHotWorksData_hotWorks_user_viewerBuilder get viewer =>
      _$this._viewer ??= new GFeedHotWorksData_hotWorks_user_viewerBuilder();
  set viewer(GFeedHotWorksData_hotWorks_user_viewerBuilder? viewer) =>
      _$this._viewer = viewer;
...
class _$GFeedHotWorksData_hotWorks_user_viewer
    extends GFeedHotWorksData_hotWorks_user_viewer {
  @override
  final String G__typename;
  @override
  final String id;
  ...
  factory _$GFeedHotWorksData_hotWorks_user_viewer(
          [void Function(GFeedHotWorksData_hotWorks_user_viewerBuilder)?
              updates]) =>
      (new GFeedHotWorksData_hotWorks_user_viewerBuilder()..update(updates))
          ._build();

  _$GFeedHotWorksData_hotWorks_user_viewer._(
      {required this.G__typename,
      required this.id,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        G__typename, r'GFeedHotWorksData_hotWorks_user_viewer', 'G__typename');
    BuiltValueNullFieldError.checkNotNull(
        id, r'GFeedHotWorksData_hotWorks_user_viewer', 'id');
    BuiltValueNullFieldError.checkNotNull(
        isFollower, r'GFeedHotWorksData_hotWorks_user_viewer', 'isFollower');
    BuiltValueNullFieldError.checkNotNull(
        isFollowee, r'GFeedHotWorksData_hotWorks_user_viewer', 'isFollowee');
    BuiltValueNullFieldError.checkNotNull(
        isMuted, r'GFeedHotWorksData_hotWorks_user_viewer', 'isMuted');
  }

  @override
  GFeedHotWorksData_hotWorks_user_viewer rebuild(
          void Function(GFeedHotWorksData_hotWorks_user_viewerBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GFeedHotWorksData_hotWorks_user_viewerBuilder toBuilder() =>
      new GFeedHotWorksData_hotWorks_user_viewerBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GFeedHotWorksData_hotWorks_user_viewer &&
        G__typename == other.G__typename &&
        id == other.id &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'GFeedHotWorksData_hotWorks_user_viewer')
          ..add('G__typename', G__typename)
          ..add('id', id)
...
class GFeedHotWorksData_hotWorks_user_viewerBuilder
    implements
        Builder<GFeedHotWorksData_hotWorks_user_viewer,
            GFeedHotWorksData_hotWorks_user_viewerBuilder> {
  _$GFeedHotWorksData_hotWorks_user_viewer? _$v;
  ...
  GFeedHotWorksData_hotWorks_user_viewerBuilder() {
    GFeedHotWorksData_hotWorks_user_viewer._initializeBuilder(this);
  }

  GFeedHotWorksData_hotWorks_user_viewerBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _G__typename = $v.G__typename;
      _id = $v.id;
  ...
  @override
  void replace(GFeedHotWorksData_hotWorks_user_viewer other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GFeedHotWorksData_hotWorks_user_viewer;
  }

  @override
  void update(
      void Function(GFeedHotWorksData_hotWorks_user_viewerBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GFeedHotWorksData_hotWorks_user_viewer build() => _build();

  _$GFeedHotWorksData_hotWorks_user_viewer _build() {
    final _$result = _$v ??
        new _$GFeedHotWorksData_hotWorks_user_viewer._(
            G__typename: BuiltValueNullFieldError.checkNotNull(G__typename,
                r'GFeedHotWorksData_hotWorks_user_viewer', 'G__typename'),
            id: BuiltValueNullFieldError.checkNotNull(
                id, r'GFeedHotWorksData_hotWorks_user_viewer', 'id'),
            isFollower: BuiltValueNullFieldError.checkNotNull(isFollower,
                r'GFeedHotWorksData_hotWorks_user_viewer', 'isFollower'),
            isFollowee: BuiltValueNullFieldError.checkNotNull(isFollowee,
                r'GFeedHotWorksData_hotWorks_user_viewer', 'isFollowee'),

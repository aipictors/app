import 'package:aipictors/widgets/flame/models/direction.dart';
import 'package:flame/components.dart';
import 'package:flame/sprite.dart';

class SamplePlayer extends SpriteAnimationComponent with HasGameRef {
  SamplePlayer() : super(size: Vector2(42.0, 55.0));

  final _playerSpeed = 300.0;

  final _animationSpeed = 0.16;

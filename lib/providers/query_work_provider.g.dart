...
String _$queryWorkHash() => r'bd749b78ab05fdeb5751882f0b49a4a781c534b7';
...
typedef QueryWorkRef = AutoDisposeFutureProviderRef<GWorkData?>;
...
/// See also [queryWork].
class QueryWorkProvider extends AutoDisposeFutureProvider<GWorkData?> {
  /// See also [queryWork].
  QueryWorkProvider(
    this.id,
  ) : super.internal(

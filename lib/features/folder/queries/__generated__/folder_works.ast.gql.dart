...
const FolderWorks = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'FolderWorks'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'folderId')),
  ...
  selectionSet: _i1.SelectionSetNode(selections: [
    _i1.FieldNode(
      ...
      arguments: [
        _i1.ArgumentNode(
          name: _i1.NameNode(value: 'id'),
          value: _i1.VariableNode(name: _i1.NameNode(value: 'folderId')),
        )
      ],
      directives: [],
      selectionSet: _i1.SelectionSetNode(selections: [

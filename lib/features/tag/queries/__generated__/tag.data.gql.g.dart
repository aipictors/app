...
class _$GTagData_tag extends GTagData_tag {
  ...
  _$GTagData_tag._(
    ...
    BuiltValueNullFieldError.checkNotNull(isLiked, r'GTagData_tag', 'isLiked');
    BuiltValueNullFieldError.checkNotNull(
        isWatched, r'GTagData_tag', 'isWatched');
    BuiltValueNullFieldError.checkNotNull(isMuted, r'GTagData_tag', 'isMuted');
  }
